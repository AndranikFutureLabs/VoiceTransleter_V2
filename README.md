...
- **Исправлена установка TTS** — обновление pip/setuptools/wheel перед установкой, `--no-build-isolation` с самого начала
- **Исправлена установка TTS** (2.2.3) — предустановка numpy/cython, фикс `transformers<4.44`
...
1. Скачайте последний релиз: `VoiceTransleter V2 Setup 2.2.4.exe`
